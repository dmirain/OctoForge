...
- `web/` — приложение `octoforge-web` (src-layout): FastAPI-обёртка, `api/` (dialog/cron/sse/schemas), `telegram/` (адаптер поверхности Telegram: models/client/bridge/poller), статика, composition root в `main.py`. Зависит от `octoforge-core`.
