...
DEFAULT_RESPONSE_MEMORY_MAX_MB = 8
...
class Settings(BaseSettings):
    ...
    # Task-scoped response memory: single documents and unstructured text
    # parked in RAM for the task's lifetime (see collections.md). The get
    # limits are what the model may deliberately spend context on.
    response_memory_max_mb: int = DEFAULT_RESPONSE_MEMORY_MAX_MB
