...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "For any user intent not covered by them, call instruction_search with a focused "
    "query first — the found scenario says how to use the tools correctly.\n"
    "3. System service notes report what happened to your runs (an interruption, "
    ...
    "instruction_save (type skill) for reuse. Save durable facts by audience: "
